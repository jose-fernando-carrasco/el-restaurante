        ...
        <div class="mx-auto col-sm-6">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">Registrar alimento</h4>
                </div>
                <div class="card-body">
                <form  method="POST" enctype="multipart/form-data"  action="{{ route('alimentos.store') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" id="precio" type="number" class="validate" name="precio" value="{{old('precio')}}" required>
                            </div>
                            <br>
                            @error('precio')
                            <span style="color:red">{{ $message }} </span>
